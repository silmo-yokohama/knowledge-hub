...
export function FavoritesPage() {
    ...
    return (
      <div className="p-6">
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-16 bg-[var(--color-surface-hover)] rounded-lg animate-pulse" />
          ))}
        </div>
      </div>
    )
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="font-display text-2xl font-bold text-[var(--color-ink)] mb-6 flex items-center gap-3">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <Link
            ...
            className="text-sm font-medium text-[var(--color-ink)] no-underline
